...
state_walk = function() {#region
	...
	enemy_ai_walk(spr_cop_turn,spr_cop_walk)
...
state_attack = function() {#region
	...
	if sprite_index != spr_cop_aim
	{
		image_speed_set(1)
		sprite_index	= spr_cop_aim
		image_index		= 0
	}
	...
	attack_dir = point_direction(x,y-5,target_x,target_y)
...
state_hit = function() {#region
	...
	else
	{
		...
		else
		{
			...
			image_speed_set(1)
			if sprite_index != spr_cop_hurtground
			{
				...
				image_speed_set(1)
				sprite_index	= spr_cop_hurtground
				image_index		= 0
			}
		}
	}
...
state_door = function() {#region
	...
	switch door_step 
	{
		case 0 : 
			...
			sprite_index = spr_cop_enterstair
		...
		case 1 : 
			...
			sprite_index = spr_cop_leavestair
