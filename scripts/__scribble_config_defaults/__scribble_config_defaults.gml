...
#macro SCRIBBLE_DEFAULT_WAVE_SIZE           1.5      //Default wave amplitude, in pixels
#macro SCRIBBLE_DEFAULT_WAVE_FREQUENCY      75       //Default wave frequency. Larger values create more "humps" over a certain number of characters
...
#macro SCRIBBLE_DEFAULT_SHAKE_SPEED         0.2     //Default shake speed. Larger values cause characters to move around more rapidly
